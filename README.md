...
#### **CGS COS Switch Shell 2G Attributes**
...
This section describes how to import the **CGS COS Switch Shell 2G** shell and configure and modify the shell’s devices.
...
1. Download the *CGS_COS_Switch_Shell_2G_offline_dependencies.zip* file, see [Downloading the Shell](#downloading-the-shell).
...
**To create a resource for the device:**
  ...
  2. From the list, select **CGS COS Switch Shell 2G**.
